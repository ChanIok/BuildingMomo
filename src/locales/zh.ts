export const zhLocale = {
  ...
  cloudScheme: {
    ...
    statusBarClickReconnect: '点击重新连接',
    history: {
      title: '同步历史',
      empty: '暂无同步记录',
      fallbackActor: '协作者',
      remoteTxUpdated: '{actor} 更新了 {n} 个物品',
      remoteTxAdded: '{actor} 新增了 {n} 个物品',
      remoteTxRemoved: '{actor} 删除了 {n} 个物品',
      remoteTxMixed: '{actor} 变更了 {total} 个物品（{detail}）',
      remoteTxMixedSegAdd: '新增 {n}',
      remoteTxMixedSegRemove: '删除 {n}',
      remoteTxMixedSegUpdate: '更新 {n}',
      remoteTxMixedJoiner: ' / ',
      userJoined: '{actor} 加入了协作',
      userLeft: '{actor} 离开了协作',
      connected: '已建立协作连接',
      reconnected: '已恢复协作连接',
      conflictReload: '检测到版本冲突，已重载方案',
      unknown: '收到一条同步事件',
    },
    status: {
      idle: '未连接',
    ...
    error: {
      ...
      roomNotFound: '该云方案不存在，请检查口令是否正确',
      roomAlreadyExists: '该口令已被占用，请换一个或留空自动生成',
      authRequired: '请先完成访问验证（设置中的口令）',
      requestFailed: '云方案请求失败：{reason}',
    },
  },
  ...
  transform: {
    ...
    slidePath: {
      ...
      moveDown: '下移节点',
      deletePoint: '删除节点',
      deleteDisabled: '至少保留 2 个节点',
      empty: '暂无节点，点击添加节点初始化滑道',
    },
    absolute: '绝对',
    relative: '相对',
    workingCoord: '(工作坐标系)',
