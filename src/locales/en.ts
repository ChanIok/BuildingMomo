export const enLocale = {
  ...
  command: {
    file: {
      ...
      joinCloudScheme: 'Join Cloud Scheme',
    },
    edit: {
      undo: 'Undo',
      redo: 'Redo',
  ...
  cloudScheme: {
    title: 'Cloud Scheme',
    dialogTitle: 'Join Cloud Scheme',
    description: 'Enter a code to join the same live editing room.',
    displayName: 'Collaborator Name',
    displayNameRequired: 'Collaborator Name',
    displayNamePlaceholder: 'Enter your name',
    create: 'Create',
    join: 'Join',
    roomCode: 'Cloud Scheme Code',
    roomCodeShort: 'Code',
    roomCodePlaceholder: 'Enter cloud scheme code',
    roomCodeOptional: 'Cloud Scheme Code (Optional)',
    roomCodeOptionalPlaceholder: 'Leave empty to generate a 6-character Base58 code',
    roomCodeOptionalHint: 'If left empty, a 6-character short code is generated automatically.',
    shareCode: 'Share Code',
    copyCode: 'Copy Code',
    disconnect: 'Disconnect',
    reconnect: 'Reconnect',
    onlineUsers: '{n} online',
    onlineMembersSeparator: ', ',
    onlineMembersLine: 'Online: {names}',
    ...
    history: {
      ...
      conflictReload: 'Version conflict detected, scheme reloaded',
      unknown: 'Received a sync event',
    },
    status: {
      idle: 'Idle',
    ...
    toast: {
      created: 'Cloud scheme created',
      joined: 'Joined cloud scheme',
      disconnected: 'Disconnected from cloud scheme',
      codeCopied: 'Cloud scheme code copied',
      remoteUpdated: 'Applied updates from another collaborator',
      conflict: 'Remote version changed; the scheme has been reloaded',
    },
    error: {
      noActiveScheme: 'Open a scheme before creating a cloud scheme',
      invalidRoomCode: 'Please enter a valid cloud scheme code',
      invalidDisplayName: 'Please enter a collaborator name',
      connectFailed: 'Failed to connect to cloud scheme',
      roomNotFound: 'This cloud scheme does not exist. Check the code.',
      roomAlreadyExists: 'This code is already in use. Pick another or leave it empty.',
      authRequired: 'Please complete site access verification (password in Settings) first.',
      requestFailed: 'Cloud scheme request failed: {reason}',
    },
  },
  ...
  transform: {
    ...
    scale: 'Scale',
    slidePath: {
      title: 'Slide Path Nodes',
      localHint: 'Node coordinates are local offsets from the origin',
      pointCount: '{n} nodes',
      pointLabel: 'Node {n}',
      originPoint: 'Origin',
      addPoint: 'Add node',
      ...
      deletePoint: 'Delete node',
      deleteDisabled: 'Keep at least 2 nodes',
      empty: 'No nodes yet. Add a node to initialize the path.',
    },
    absolute: 'Absolute',
    relative: 'Relative',
